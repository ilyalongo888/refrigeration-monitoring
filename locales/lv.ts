...
export const lv: Dictionary = {
  ...
  pricingModel: {
    ...
    monitoring: {
      ...
      price: "€20",
      period: "par aktīvo sensoru mēnesī",
      included: [
        "monitorings 24/7",
        "rādījumu vēsture",
      ...
      note: "Maksa tiek aprēķināta pēc aktīvo sensoru skaita. Kopsumma = sensoru skaits × €20.",
    },
    cta: "Aprēķināt cenu",
  },
  costExamples: {
    ...
    items: [
      { label: "Neliels objekts", sensors: "5 sensori", price: "€100 / mēnesī" },
      { label: "Vidējs objekts", sensors: "10 sensori", price: "€200 / mēnesī" },
      { label: "Lielāks objekts", sensors: "15 sensori", price: "€300 / mēnesī" },
      { label: "Liels objekts", sensors: "25 sensori", price: "€500 / mēnesī" },
    ],
  ...
  calculator: {
    ...
    result: {
      ...
      monthlyUnit: "/ mēnesī",
      monthlyNote: "Precīza tehniskā konfigurācija tiek apstiprināta pēc iekārtas savietojamības pārbaudes.",
      fromPrefix: "no",
  ...
  targetCustomers: {
    ...
    primary: [
      ...
      "Saldētas produkcijas ražotāji un izplatītāji",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "€20 par aktīvo sensoru mēnesī.",
      },
      {
